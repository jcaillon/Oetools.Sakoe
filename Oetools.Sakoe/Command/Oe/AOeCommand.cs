...
// This file (AOeBaseFuck.cs) is part of Oetools.Sakoe.
// 
    ...
    public abstract class AOeCommand : BaseCommand {
        ...
        protected string GetCurrentProjectFilePath() {
            ...
            if (list.Count == 0) {
                ...
                if (list.Count > 1) {
                    throw new CommandException($"Ambiguous project, found {list.Count} project files in {OeBuilderConstants.OeProjectDirectory}, specify the project file to use in the command line.");
                }
            }
